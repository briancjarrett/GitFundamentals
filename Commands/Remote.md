...
**Note**: While the repositories (local and remote) are related and track the same project, that can have different states if changes are not shared between the two.
